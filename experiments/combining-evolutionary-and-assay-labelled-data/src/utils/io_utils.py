...
def load_data_split(dataset_name, split_id, seed=0, ignore_gaps=False):
    ...
    # print(dataset_name,len(fast_eval_files))
    data_path =  os.path.join(f'{os.getenv("PROJECT_ROOT", default=os.getcwd())}/data/fitness/proteingm_groundtruth', dataset_name, 'data.csv')
    print(data_path)
